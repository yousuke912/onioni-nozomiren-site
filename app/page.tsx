...
const awards = [
  ...
  },
  {
    year: "2013",
    items: ["下石井公園演舞場賞"],
    image: "/images/history/year-2013.jpg",
    alt: "2013年の鬼々よろしく魁望蓮",
  },
  {
    year: "2012",
      ...
      <main id="main-content">
        ...
        <section className="philosophy section-pad" id="philosophy">
          <div className="page-shell">
            ...
            <div className="philosophy__more" data-reveal>
              <p>3つの「向き合い方」、「かっこいい踊り子」とは、踊り子と大人に期待すること。</p>
              <Link className="button button--primary" href="/philosophy/">
                運営理念の全文を読む
                <ArrowRightIcon />
              </Link>
            </div>
